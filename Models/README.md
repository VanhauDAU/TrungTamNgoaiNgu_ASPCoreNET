...
- `Models/KhoaHocVaLopHoc/`
  - `DanhMucKhoaHoc.cs`, `KhoaHoc.cs`, `HocPhi.cs`, `CaHoc.cs`, `PhongHoc.cs`, `LopHoc.cs`, `DangKyLopHoc.cs`, `BuoiHoc.cs`, `DiemDanh.cs`, `BaiThi.cs`, `DiemBaiThi.cs`
- `Models/TaiChinh/`
  - `HoaDon.cs`, `PhieuThu.cs`, `Luong.cs`, `LuongChiTiet.cs`
- `Models/CoSoDaoTao/`
  - `CoSoDaoTao.cs`, `TinhThanh.cs`
- `Models/NoiDungVaTuongTac/`
  - `DanhMucBaiViet.cs`, `Tag.cs`, `BaiViet.cs`, `LienHe.cs`, `LienHeLichSu.cs`, `LienHePhanHoi.cs`, `DanhGiaGiaoVien.cs`, `PhanHoi.cs`, `TaiLieu.cs`, `NoiDungBaiHoc.cs`, `ThongBao.cs`, `ThongBaoNguoiDung.cs`, `ThongBaoTepDinh.cs`, `Setting.cs`
